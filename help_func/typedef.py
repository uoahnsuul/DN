...
if __name__=='__main__':
    path = 'C:\\Users\\dms-pc110\\PycharmProjects\\DN-master\\Dataset\\TRAINING\\BLOCK\\AI_PNG_0001_2040x1400_8bit_P420_32_POC0\\PPSParam.npz'
    path2 = 'C:\\Users\\dms-pc110\\PycharmProjects\\DN-master\\Dataset\\TRAINING\\BLOCK\\AI_PNG_0001_2040x1400_8bit_P420_32_POC0\\Depth.npy'
    import numpy as np

    pps_parm = np.load(path)
    depth = np.load(path2)
    print(' ')
